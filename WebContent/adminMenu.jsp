		...
		<div id="sidebar-menu">
			<ul>
				...
				<li class="has_sub"><a href="#"
					class="waves-effect waves-light"><i class="ion-android-contacts"></i><span>Manage
							User</span><span class="pull-right"><i class="md md-add"></i></span></a>
					<ul class="list-unstyled">
						<li><a href="addUser.jsp">Add User</a></li>
						<li><a href="${pageContext.request.contextPath}/UserRegistrationController?flag=loadUserRegistrationSearchData">Search User</a></li>
					</ul></li>
